...
<a href="http://localhost/PaginaArq/stock.php">Tabla de Stock</a>
  ...
  <h2 style="background-color: #1e3928 ; color: white; font-size: 38px; font-family: 'Anton', sans-serif;" class="text-uppercase text-center"> Stock para la Rotonda de Comidas  </h2>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Insercion del Stock</h4>
      ...
      <div class="modal-body">
      	...
      	<div class="form-group">
      		...
      		<input type="text" name="id_ingrediente" id="id_ingrediente" class="form-control">
      	</div>
        <div class="form-group">
          ...
          <input type="text" name="id_producto" id="id_producto" class="form-control">
       	...
       	<div class="form-group">
      		...
      		<input type="text" name="cantidad_disponible" id="cantidad_disponible" class="form-control">
      	</div>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      		...
      		<div class="form-group">
      		<label> Id Ingrediente </label>
      		<input type="text" name="id_ingrediente" id="update_ingrediente" class="form-control">
      	</div>
        <div class="form-group">
          <label> Id Producto </label>
          <input type="text" name="id_producto" id="update_producto" class="form-control">
        </div>
      	<div class="form-group">
      		<label> Cantidad Disponible </label>
      		<input type="text" name="cantidad_disponible" id="update_cdisponible"  class="form-control">
      	</div>
     </div>
...
function GetUserDetails(id_stock){
	  $("#id_stock").val(id_stock);
	  $.post("backend_stock.php", {
            id_stock: id_stock
        },
        function (data, status) {
            ...
            $("#update_ingrediente").val(user.id_ingrediente);
            $("#update_producto").val(user.id_producto);
            $("#update_cdisponible").val(user.cantidad_disponible);
        }
    );
...
function UpdateUserDetails() {
    var id_ingrediente = $("#update_ingrediente").val();
    var id_producto = $("#update_producto").val();
    var cantidad_disponible = $("#update_cdisponible").val();
